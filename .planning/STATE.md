...
**Features:**
- --latest shown as recommended method for automation
- --date preserved as fallback for historical analysis
- GetLatestLogDateFolder() and GetLogFilesFromLatest() documented
- Windows/WSL path compatibility note for cross-environment usage
