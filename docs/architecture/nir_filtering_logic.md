...
*   **Pass Condition**: **4 or more** out of the 5 criteria must be satisfied.
*   **Fail Condition**: 3 or fewer criteria satisfied.
...
| **y_std** | `StdDev` (All) | `>= 0.010` | Overall Variability |
...
> [!NOTE]
> **Limitations**: These criteria focus on **signal magnitude**. High-amplitude noise can sometimes satisfy 4/5 criteria (causing False Positives), as observed in recent tests.
