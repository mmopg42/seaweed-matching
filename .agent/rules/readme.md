...
├── FileOperations (MoveService, DeleteService, PathManagementService)
├── Analytics (StatisticsService, AbnormalDetectorService)
├── ImageProcessing (ImageProcessingService, LruCache)
├── Configuration (ConfigurationManager)
├── NIR (NirSpectrumParser, SpcTxtNirFileResolver)
└── ProgramLaunching (GeneralCameraLauncher, NirCameraLauncher)
         ↓
Models Layer
├── FileGroup, UnmatchedFiles
